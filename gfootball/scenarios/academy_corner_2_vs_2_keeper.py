...
def build_scenario(builder):
    ...
    builder.SetBallPosition(0.9004, -0.3648)

    builder.SetTeam(Team.e_Left)
    builder.AddPlayer(0.8694, -0.4051, e_PlayerRole_CF)
    builder.AddPlayer(0.6210, -0.0043, e_PlayerRole_RM)

    builder.SetTeam(Team.e_Right)
    builder.AddPlayer(0.9669, -0.0070, e_PlayerRole_GK)
    builder.AddPlayer(0.7319, -0.0070, e_PlayerRole_CB)
